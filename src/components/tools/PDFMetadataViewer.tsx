...
import { Upload, FileText, Download, Copy, Trash2, Shield, Lock, Unlock, Calendar, User, Info, FileCode, Settings2 } from 'lucide-react';
              ...
              {metadata && (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <MetadataItem icon={Settings2} label="Creator" value={metadata.creator} />
