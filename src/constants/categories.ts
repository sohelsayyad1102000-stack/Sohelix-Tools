...
export const CATEGORY_INFO: Record<string, { title: string, description: string, icon: any, content: string }> = {
  ...
  'utilities': {
    ...
    icon: Settings,
    content: 'Streamline your workflow with our collection of free utility tools. Designed for developers, data analysts, and everyday users, these tools help you handle common technical tasks with ease. Format and minify JSON data, convert between Unix timestamps and human-readable dates, or encode and decode Base64 strings instantly. All processing happens locally in your browser, ensuring your data stays private and secure while delivering lightning-fast results.'
  },
  'finance-tools': {
    title: 'Free Finance Tools',
